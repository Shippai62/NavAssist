#define button1 2 // this button used for only Alarm mode
#define button2 3 // this button used for Alarm & Vibrator mode
#define button3 4 // this button used for only Vibrator mode

#define buzzer 5 // this pin used for Alarm
#define motor  6 // this pin used for Vibrator Motor
